                  ...
                  if (msg.text.includes("reaching out regarding your post")) {
                    ...
                    return (
                      <div key={msg.id || msg.__id || i} className="w-full my-1 flex flex-col items-start">
                        ...
                        <div className="max-w-md w-full bg-amber-50/80 border border-amber-200/80 rounded-xl p-3 shadow-2xs text-gray-800 space-y-1 font-sans">
                          <div className="flex items-center gap-1.5 text-amber-900 font-headline font-bold text-[10px] uppercase tracking-wider">
