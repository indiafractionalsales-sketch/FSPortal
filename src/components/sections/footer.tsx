        ...
        <div className="container mx-auto px-4 md:px-8 max-w-[1400px]">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-12 border-b border-white/10 pb-12 mb-8">
            ...
            <div className="flex flex-col items-center md:items-end gap-4">
              ...
              {/* Security Trust Shield Pill */}
              <button
                onClick={() => setIsSecurityModalOpen(true)}
                className="mt-2 flex items-center gap-2 px-3 py-1.5 bg-amber-400/10 hover:bg-amber-400/20 border border-amber-400/30 text-amber-300 text-xs rounded-full transition-all duration-300 cursor-pointer"
              >
                <ShieldCheck className="w-4 h-4 text-amber-400" />
                <span className="font-sans font-medium">Secured by Cloudflare & Anti-Fraud Shield</span>
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] md:text-xs font-sans text-white/50 tracking-widest uppercase">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6">
              <button
                onClick={() => setIsSecurityModalOpen(true)}
                className="hover:text-amber-400 text-amber-300/80 font-bold transition-colors flex items-center gap-1 cursor-pointer normal-case"
              >
