  ...
  return (
    <>
      <div className="relative bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden">
          ...
          {post.postType === "obo" && (
            ...
            !isOwner ? (
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-2 font-headline font-bold uppercase tracking-widest text-[10px] transition-all rounded-lg ${post.paymentStatus === 'sold' || !acceptingOffers
        ...
        {post.paymentStatus === 'sold' && (
          <div className="border-t border-gray-100 mx-4 py-3 font-sans">
            <div className="flex items-center justify-between gap-2 flex-wrap">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <a
                  ...
                  className="px-3 py-1.5 bg-red-50/80 hover:bg-red-100 text-[#701010] border border-red-200/80 rounded-lg text-[10px] font-headline font-bold uppercase tracking-wider transition-all cursor-pointer flex items-center gap-1.5 shadow-2xs hover:shadow-xs"
                >
                ...
                {((post.postType === 'sp' && (currentUid === post.ownerUid || currentUid === post.paymentLockedBy)) ||
                  (post.postType === 'obo' && (currentUid === post.ownerUid || currentUid === post.paymentLockedBy))) && (
                    <button
                      ...
                      className="px-3 py-1.5 bg-white hover:bg-gray-50 text-gray-800 border border-gray-200 text-[10px] font-headline font-bold uppercase tracking-wider rounded-lg flex items-center gap-1.5 transition-all cursor-pointer shadow-2xs hover:shadow-xs"
                    >
                      📈 Insights
                    </button>
                  )}
                ...
                {((post.postType === 'sp' && currentUid === post.ownerUid) ||
                  (post.postType === 'obo' && currentUid === post.paymentLockedBy)) && (
                    <button
                      ...
                      className="px-3 py-1.5 bg-gray-900 hover:bg-gray-800 text-white text-[10px] font-headline font-bold uppercase tracking-wider rounded-lg flex items-center gap-1.5 shadow-2xs transition-all cursor-pointer"
                    >
                ...
                {isPartner && post.spPostSubType !== "consultancy" && (
                  <button
                    ...
                    className="px-3 py-1.5 bg-indigo-900 hover:bg-indigo-800 text-white text-[10px] font-headline font-bold uppercase tracking-wider rounded-lg flex items-center gap-1.5 shadow-2xs transition-all cursor-pointer"
                  >
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {((post.postType === 'sp' && currentUid === post.paymentLockedBy) ||
                  (post.postType === 'obo' && currentUid === post.ownerUid)) && (
                    <button
                      ...
                      className="px-3.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-[10px] font-headline font-bold uppercase tracking-wider transition-all shadow-2xs hover:shadow-xs active:scale-[0.98] cursor-pointer flex items-center gap-1.5"
                    >
                      💰 Release Payment
                    </button>
                  )}
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-200/80 rounded-lg text-[10px] font-headline font-bold uppercase tracking-wider transition-all cursor-pointer flex items-center gap-1.5 shadow-2xs"
                >
