          ...
          <ul className="space-y-1.5">
            ...
            <li>
              <button 
                ...
                className="w-full flex items-center gap-2.5 px-2 py-2 bg-amber-400/10 hover:bg-amber-400/20 border border-amber-400/30 text-amber-900 transition-all rounded-lg text-left cursor-pointer"
              >
                <span className="text-base">🛡️</span>
                <span className="text-xs font-headline font-bold uppercase tracking-wider text-amber-900">Trust & Security</span>
              </button>
            </li>
          </ul>
        </div>
